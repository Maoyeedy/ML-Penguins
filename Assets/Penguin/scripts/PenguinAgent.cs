...
public class PenguinAgent : Agent
{
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        float turnAmount = 0f;
        if (Mathf.Approximately(actionBuffers.DiscreteActions[1], 1f))
        {
            turnAmount = -1f;
        }
        else if (Mathf.Approximately(actionBuffers.DiscreteActions[1], 2f))
        {
            turnAmount = 1f;
        }
    ...
    private void RegurgitateFish()
    {
        ...
        {
            EndEpisode();
            //next episode auto start, as it's EndEpisodeAndReset
        }
    }
}
